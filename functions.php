<?php
/**
 * TDVids functions and definitions
 *
 * @package TDVids
 */
...
if ( ! function_exists( 'tdvids_setup' ) ) :
/**
 ...
 */
function tdvids_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on TDVids, use a find and replace
	 * to change 'tdvids' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'tdvids', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'tdvids' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'tdvids_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // tdvids_setup
add_action( 'after_setup_theme', 'tdvids_setup' );
 ...
 */
function tdvids_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'tdvids' ),
		'id'            => 'sidebar-1',
		'description'   => '',
 ...
 */
function tdvids_scripts() {
	wp_enqueue_style( 'tdvids-style', get_stylesheet_uri() );
